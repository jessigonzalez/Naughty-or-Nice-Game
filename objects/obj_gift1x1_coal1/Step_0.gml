...
or obj_gift1x1_coal2.isSelected=true or obj_gift1x1_coal3.isSelected=true or obj_gift1x1_coal4.isSelected=true or obj_gift1x1_coal5.isSelected=true)
{
...
if(position_meeting(mouse_x,mouse_y,self) and mouse_check_button(mb_left) and selectedAnotheGift=false and assignedChild  and assignedChild=true)
{
